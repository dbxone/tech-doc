...
**程序可能会 更新，请**[**点击这里**](https://github.com/dbxhain/dbx-core/releases/latest)**下载最新程序。**
...
| :--- | :--- |
| github | [https://github.com/dbxhain/dbx-core/releases/download/1.0.180604/dbx\_1.0.180604.tar.gz](https://github.com/dbxhain/dbx-core/releases/download/1.0.180604/dbx_1.0.180604.tar.gz) |
...
上面的json文件中，每一行是一个json，其中id为对象id, 1.25.x为忠诚计划余额对象, 2.5.x为余额对象; 对象id文件参考[这里](https://github.com/dbxhain/dbx-core/wiki/Objects-and-IDS)
